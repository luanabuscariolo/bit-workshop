---
title: "Parte 3 — Os Coletáveis"
sidebar_position: 3
---

# Passo a passo de como fazer moedas coletáveis e um báu que só abre se o jogador coletar a chave

![Exemplo de player coletando moedas e chave](/img/godot_collectables.gif)
...
![Árvore de nós da cena da moeda](/img/godot_arvore_nos_coins.png)
...
![Exemplo de como adicionar uma animação ao nó AnimatedSprite2D](/img/godot_add_animation_coin.png)
...
![Exemplo de como selecionar os frames de uma imagem para animá-los](/img/godot_SelectFrames.png)
...
![Organizando as camadas](/img/godot_layers_collision.png)
...
![Camada de colisões](/img/godot_collision_coin.png)
...
## Agora vamos fazer uma chave coletável que abre um baú: 🔑 🔓
...
![Árvore de nós da cena da chave](/img/godot_arvore_nos_key.png)
...
![Animação da chave com o nó AnimationPlayer](/img/godot_animation_key.png)
...
![Árvore de nós da cena do baú](/img/godot_arvore_nos_bau.png)
...
![Animação de abertura do baú](/img/godot_animacao_bau.png)
