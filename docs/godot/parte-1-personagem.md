---
title: "Parte 1 — O Personagem"
sidebar_position: 1
---

# Passo a passo para fazer o Personagem

![Personagem](/img/godot_player.gif)
...
![Árvore de nós do Personagem](/img/godot_arvore_player.png)
...
![Ilustração do pulo do personagem como uma parábola e as fórmulas para velocidade e gravidade](/img/godot_calculo_pulo.png)
...
![Ilustração dos nós de colisão no personagem](/img/godot_player_colisoes.png)
...
![Árvore de nós da cena principal](/img/godot_tree_world1.png)
...
![Árvore de nós da cena world_01](/img/godot_arvore_world_spikes.png)
...
![Árvore de nós da cena world_01](/img/godot_spike_config.png)
